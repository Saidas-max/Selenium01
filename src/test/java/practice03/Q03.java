 ...
 */
  ...
  public void test() {
    ...
    List<WebElement> deleteButtonListBeforeDelete = driver.findElements(By.xpath("//button[@onclick='deleteElement()']"));
    System.out.println("Delete Buttons Before Delete: " + deleteButtonListBeforeDelete.size());//80
for(int  i=0; i<20; i++){
  ...
  deleteButtonList.get(i).click();
    ...
    System.out.println("Delete Buttons After Delete: "
            + deleteButtonListAfterDelete.size());
